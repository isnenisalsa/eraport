                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nis" placeholder="Inputkan nis Anda"
                                name="nis" value="{{ old('nis') }}" maxlength="16">
                            @if ($errors->has('nis'))
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="no_telp_ayah"
                                placeholder="Inputkan Nomor Telepon Ayah" name="no_telp_ayah" value="{{ old('no_telp_ayah') }}"
                                maxlength="12">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_ibu"
                                placeholder="Inputkan Tempat Lahir Anda" name="nama_ibu"
                                value="{{ old('nama_ibu') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="pekerjaan_ibu"
                                placeholder="Inputkan Tanggal Lahir Anda" name="pekerjaan_ibu"

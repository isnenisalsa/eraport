                    ...
                    <form action="/update-username" method="POST">
                        ...
                        <ul class="list-group text-start mt-3">
                            <li class="list-group-item">
                                ...
                                <input type="text" name="username" id="username" class="form-control mt-2" value="{{ $user->username }}" required>
                                <label for="email" class="fw-bold mt-2">Email:</label>
                                <input type="text" name="email" id="email" class="form-control mt-2" value="{{ $user->email }}" required>
                            </li>
                        </ul>
                    </form>
                </div>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-light border-bottom">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#edit-akun" data-bs-toggle="tab">Edit Akun</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                        ...
                        <div class="tab-pane fade show active" id="profile">
                            ...
                            <form action="{{ route('profile.update') }}" method="POST">
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <label for="confirm" class="form-check-label">Saya yakin akan mengubah data tersebut</label>
                                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        // Fungsi untuk menampilkan tab sesuai hash di URL
        ...
        // Tambahkan event listener untuk memperbarui hash URL
        ...
        // Dengarkan perubahan hash URL (misalnya pengguna menekan tombol back/forward)
